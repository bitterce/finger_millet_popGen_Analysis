...
SCRATCH_DIR=~/script_dir/runtime_scripts/joint_parallel_20samples/scratch_GATKv4_jointgenotype_sa0055
echo "at $SCRATCH_DIR"
...
gunzip -c $DATA_DIR/sa00gz > $SCRATCH_DIR/21.g.vcf
cd $SCRATCH_DIR20 exit 1
