...
#### SET THE STAGE
SCRATCH_DIR=/scratch/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54_314_temp$$
...
output = list()
output[['Name']] = '314'
output[['BAM [File]']] = 'p1634/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54/314.bam'
output[['BAI [File]']] = 'p1634/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54/314.bam.bai'
output[['IGV [Link]']] = 'p1634/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54/314-igv.html'
output[['Species']] = ''
output[['refBuild']] = 'Finger_millet/KEN/DENOVO_v2.0_A_subgenome/Annotation/Release_01-2019-02-04'
output[['paired']] = 'true'
output[['refFeatureFile']] = ''
output[['strandMode']] = ''
output[['Read Count']] = '18402545'
output[['IGV [File]']] = 'p1634/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54/314-igv.html'
output[['PreprocessingLog [File]']] = 'p1634/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54/314_preprocessing.log'
...
input[['Name']] = '314'
input[['Condition']] = ''
input[['Read1']] = 'p1634/HiSeq4000_20170828_RUN379_o3646/20170828.A-314_R1.fastq.gz'
input[['Read2']] = 'p1634/HiSeq4000_20170828_RUN379_o3646/20170828.A-314_R2.fastq.gz'
input[['Species']] = ''
input[['FragmentSize']] = ''
input[['SampleConc']] = ''
input[['Tube']] = ''
...
g-req -w copy 314.bam /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54
g-req -w copy 314.bam.bai /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54
g-req -w copy 314-igv.html /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54
g-req -w copy 314_preprocessing.log /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54
cd /scratch
rm -rf /scratch/BWA_Reseq_low_301_350_on_A_2020-09-17--12-45-54_314_temp$$ || exit 1
