...
#### SET THE STAGE
SCRATCH_DIR=/scratch/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11_326_temp$$
...
output = list()
output[['Name']] = '326'
output[['BAM [File]']] = 'p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11/326.bam'
output[['BAI [File]']] = 'p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11/326.bam.bai'
output[['IGV [Link]']] = 'p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11/326-igv.html'
output[['Species']] = ''
output[['refBuild']] = 'Finger_millet/KEN/DENOVO_v2.0_B_subgenome/Annotation/Release_01-2019-02-04'
output[['paired']] = 'true'
output[['refFeatureFile']] = ''
output[['strandMode']] = ''
output[['Read Count']] = '11426914'
output[['IGV [File]']] = 'p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11/326-igv.html'
output[['PreprocessingLog [File]']] = 'p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11/326_preprocessing.log'
...
input[['Name']] = '326'
input[['Condition']] = ''
input[['Read1']] = 'p1634/HiSeq4000_20170828_RUN379_o3646/20170828.A-326_R1.fastq.gz'
input[['Read2']] = 'p1634/HiSeq4000_20170828_RUN379_o3646/20170828.A-326_R2.fastq.gz'
input[['Species']] = ''
input[['FragmentSize']] = ''
input[['SampleConc']] = ''
input[['Tube']] = ''
...
g-req -w copy 326.bam /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11
g-req -w copy 326.bam.bai /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11
g-req -w copy 326-igv.html /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11
g-req -w copy 326_preprocessing.log /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11
cd /scratch
rm -rf /scratch/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11_326_temp$$ || exit 1
