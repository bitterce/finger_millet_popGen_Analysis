...
#### SET THE STAGE
SCRATCH_DIR=/scratch/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11_320_temp$$
...
output = list()
output[['Name']] = '320'
output[['BAM [File]']] = 'p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11/320.bam'
output[['BAI [File]']] = 'p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11/320.bam.bai'
output[['IGV [Link]']] = 'p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11/320-igv.html'
output[['Species']] = ''
output[['refBuild']] = 'Finger_millet/KEN/DENOVO_v2.0_B_subgenome/Annotation/Release_01-2019-02-04'
output[['paired']] = 'true'
output[['refFeatureFile']] = ''
output[['strandMode']] = ''
output[['Read Count']] = '13519974'
output[['IGV [File]']] = 'p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11/320-igv.html'
output[['PreprocessingLog [File]']] = 'p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11/320_preprocessing.log'
...
input[['Name']] = '320'
input[['Condition']] = ''
input[['Read1']] = 'p1634/HiSeq4000_20170828_RUN379_o3646/20170828.A-320_R1.fastq.gz'
input[['Read2']] = 'p1634/HiSeq4000_20170828_RUN379_o3646/20170828.A-320_R2.fastq.gz'
input[['Species']] = ''
input[['FragmentSize']] = ''
input[['SampleConc']] = ''
input[['Tube']] = ''
...
g-req -w copy 320.bam /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11
g-req -w copy 320.bam.bai /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11
g-req -w copy 320-igv.html /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11
g-req -w copy 320_preprocessing.log /srv/gstore/projects/p1634/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11
cd /scratch
rm -rf /scratch/BWA_Reseq_low_301_350_on_B_2020-09-17--12-46-11_320_temp$$ || exit 1
