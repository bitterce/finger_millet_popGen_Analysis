...
#### SET THE STAGE
SCRATCH_DIR=/scratch/GATKv4JointGenoTypes_A_only_Ecor_snp_indel_filtered_by_PR202_2019-08-18--16-13-18_GATKv4_Genotyping_temp$$
GSTORE_DIR=/srv/gstore/projects
INPUT_DATASET=/srv/gstore/projects/p1634/GATKv4JointGenoTypes_A_only_Ecor_snp_indel_filtered_by_PR202_2019-08-18--16-13-18/input_dataset.tsv
...
EOF
ruby filter_out_snps_indels_by_reference_vcf.GATKv4_Genotyping.rb /srv/gstore/projects/p1634/GATKv4JointGenoTypes_A_only_Ecor_snp_indel_2019-08-15--16-22-01/GATKv4_Genotyping.filtered.vcf.gz /srv/gstore/projects/p1634/GATKv4JointGenoTypes_A_only_PR202_snp_indel_2019-08-11--08-42-57/GATKv4_Genotyping.filtered.vcf.gz -o GATKv4_Genotyping.filtered_by_reference_vcf.vcf.gz 2> filter_out_snps_indels_by_reference_vcf.GATKv4_Genotyping.log


#### JOB IS DONE WE PUT THINGS IN PLACE AND CLEAN AUP
g-req -w copy GATKv4_Genotyping.filtered_by_reference_vcf.vcf.gz /srv/gstore/projects/p1634/GATKv4JointGenoTypes_A_only_Ecor_snp_indel_filtered_by_PR202_2019-08-18--16-13-18
g-req -w copy filter_out_snps_indels_by_reference_vcf.GATKv4_Genotyping.rb /srv/gstore/projects/p1634/GATKv4JointGenoTypes_A_only_Ecor_snp_indel_filtered_by_PR202_2019-08-18--16-13-18
g-req -w copy filter_out_snps_indels_by_reference_vcf.GATKv4_Genotyping.log /srv/gstore/projects/p1634/GATKv4JointGenoTypes_A_only_Ecor_snp_indel_filtered_by_PR202_2019-08-18--16-13-18
cd /scratch
rm -rf /scratch/GATKv4JointGenoTypes_A_only_Ecor_snp_indel_filtered_by_PR202_2019-08-18--16-13-18_GATKv4_Genotyping_temp$$ || exit 1
